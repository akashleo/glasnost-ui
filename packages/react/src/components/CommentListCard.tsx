...
import type { CommentListCardProps } from '@glasnost/shared'
  ...
  return (
    ...
    >
      ...
      <style>
        ...
        .glasnost-comment-card .comment-item {
          padding: 1.5rem;
          margin-bottom: 1rem;
          background: linear-gradient(135deg, 
        ...
        .glasnost-comment-card .comment-item:hover {
          background: linear-gradient(135deg, 
            rgba(255, 255, 255, 0.2) 0%, 
        ...
        .glasnost-comment-card .comment-author {
          font-weight: 700;
        ...
        .glasnost-comment-card .comment-text {
          color: rgba(255, 255, 255, 0.8);
          line-height: 1.7;
          font-size: 1rem;
        ...
        .glasnost-comment-card .comment-meta {
          font-size: 0.875rem;
