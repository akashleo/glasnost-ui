<script lang="ts">
  ...
  let selectedComponent = 'profile-card';
  ...
  $: currentGradient = backgroundOptions[selectedBackground].svg;
  $: currentComponent = componentList.find(c => c.id === selectedComponent);
  ...
  function handleSizeToggle(size, checked) {
    toggleSizes[size] = checked;
  }

  function handleVariantToggle(variant, checked) {
    toggleVariants[variant] = checked;
  }

  function handleStateToggle(state, checked) {
      ...
      <section class="main-section">
        <div class="component-showcase">
          <div class="showcase-content">
            <!-- Profile Card -->
            {#if selectedComponent === 'profile-card'}
            ...
            <!-- Glass Buttons -->
            {:else if selectedComponent === 'glass-buttons'}
              <div class="demo-container">
            ...
            <!-- Comment Card -->
            {:else if selectedComponent === 'comment-card'}
              <div class="demo-container">
                <CommentListCard 
            ...
            <!-- Toggle Button -->
            {:else if selectedComponent === 'toggle-button'}
              <div class="demo-container">
                  ...
                  <div class="button-group">
                    ...
                    <div class="toggle-row">
                      <GlassToggleButton 
                        ...
                        on:change={e => handleSizeToggle('small', e.detail)}
                        label="Small Toggle" 
                      />
                      <GlassToggleButton 
                        size="medium" 
                        checked={toggleSizes.medium}
                        on:change={e => handleSizeToggle('medium', e.detail)}
                        label="Medium Toggle" 
                      />
                      <GlassToggleButton 
                        size="large" 
                        checked={toggleSizes.large}
                        on:change={e => handleSizeToggle('large', e.detail)}
                        label="Large Toggle" 
                      />
                    </div>
                  </div>
                  ...
                  <div class="button-group">
                    ...
                    <div class="toggle-row">
                      <GlassToggleButton 
                        ...
                        on:change={e => handleVariantToggle('primary', e.detail)}
                        label="Primary Small" 
                      />
                      <GlassToggleButton 
                        variant="secondary"
                        ...
                        on:change={e => handleVariantToggle('secondary', e.detail)}
                      ...
                      <GlassToggleButton 
                        ...
                        on:change={e => handleVariantToggle('accent', e.detail)}
                        label="Accent Large" 
                      />
                    </div>
                  </div>
            ...
            <!-- Hamburger Menu -->
            {:else if selectedComponent === 'hamburger-menu'}
              <div class="demo-container">
            ...
            <!-- Navbar -->
            {:else if selectedComponent === 'navbar'}
              <div class="demo-container">
      ...
      <aside class="sidebar-right">
        <div class="sidebar-content">
          ...
          <div class="background-options">
            {#each backgroundOptions as option, index (index)}
              <button 
                class="background-option"
                class:active={selectedBackground === index}
                style="background: {option.svg}"
                on:click={() => selectBackground(index)}
                title={option.name}
              >
